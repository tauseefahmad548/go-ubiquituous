    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                if (i == 0) {
                    PutDataMapRequest putDataMapRequest = PutDataMapRequest.create("/currentWeather");
                    DataMap dataMap = putDataMapRequest.getDataMap();
                    dataMap.putDouble("max_temp", high);
                    dataMap.putDouble("min_temp", low);
                    dataMap.putInt("weather_type", weatherId);
